...
<!-- Libs JS -->
<script src="{{url('assets/js/off-canvas.js')}}" defer></script>
<script src="{{url('assets/dist/libs/apexcharts/dist/apexcharts.min.js?1684106062')}}" defer></script>
<script src="{{url('assets/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062')}}" defer></script>
<script src="{{url('assets/dist/libs/jsvectormap/dist/maps/world.js?1684106062')}}" defer></script>
<script src="{{url('assets/dist/libs/jsvectormap/dist/maps/world-merc.js?1684106062')}}" defer></script>
<script src="{{url('assets/dist/libs/nouislider/dist/nouislider.min.js?1684106062')}}" defer></script>
<script src="{{url('assets/dist/libs/litepicker/dist/litepicker.js?1684106062')}}" defer></script>
<script src="{{url('assets/dist/libs/tom-select/dist/js/tom-select.base.min.js?1684106062')}}" defer></script>
<script src="{{url('frontend/js/off-canvas.js')}}"></script>
<script src="{{url('frontend/js/hoverable-collapse.js')}}"></script>
<script src="{{url('frontend/js/template.js')}}"></script>
<script src="{{url('frontend/js/todolist.js')}}"></script>
<!-- endinject -->
<!-- Custom js for this page-->
<script src="{{url('frontend/js/file-upload.js')}}"></script>
<!-- Tabler Core -->
...
<script>
    document.getElementById('datepicker-icon-prepend').value = new Date().toLocaleDateString('en-GB');
</script>
<script>
    // @formatter:off
